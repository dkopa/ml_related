...
def _distorted_inputs(batch_size, randFlip=True):
  ...
  filenames = ["/home/hasnat/Desktop/TensorFlowCodes/vmf/dataset/mnist_train.bin"]
...
def _inputs(eval_data, batch_size):
  ...
  filenames = ["/home/hasnat/Desktop/TensorFlowCodes/vmf/dataset/mnist_test.bin"]
...
def inputs(eval_data):
  images, labels = _inputs(eval_data=eval_data, batch_size=FLAGS.batch_size)
